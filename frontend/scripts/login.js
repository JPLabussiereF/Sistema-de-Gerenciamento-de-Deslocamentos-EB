document.addEventListener('DOMContentLoaded', function() {
    ...
    // Função para validar formato de CPF ou email @EB
    function validarCpfOuEmail(valor) {
        // Verifica se é um CPF (somente números, 11 dígitos)
        const cpfRegex = /^\d{11}$/;
        
        // Verifica se é um email que termina com @EB
        const emailRegex = /^[a-zA-Z0-9._-]+@EB$/i;
        
        return cpfRegex.test(valor) || emailRegex.test(valor);
    }
});